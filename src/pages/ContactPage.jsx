  ...
  return (
    <div className="min-h-screen bg-pink-50 py-16 px-4">
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-8">
        ...
        {/* İletişim Formu */}
        <form ref={form} onSubmit={gonder} className="bg-white rounded-2xl p-8 shadow-sm flex flex-col gap-4">
          ...
          <button
            ...
            className="bg-pink-300 text-white py-3 rounded-full hover:bg-pink-400 transition text-lg disabled:opacity-50"
          >
            {durum === 'gonderiliyor' ? 'Gönderiliyor...' : 'Gönder'}
          </button>

          {durum === 'basarili' && (
            <p className="text-green-400 text-center text-sm">✅ Mesajınız başarıyla gönderildi!</p>
          )}
          {durum === 'hata' && (
            <p className="text-red-400 text-center text-sm">❌ Bir hata oluştu, tekrar deneyin.</p>
          )}
